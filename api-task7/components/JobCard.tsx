...
const JobCard = ({ title, id, description, work_type, position_type, company, location, image, slug }: JobCardProps) => {
    ...
    return (
        <div className="bg-white dark:bg-gray-900 border-1 border-gray-300 rounded-2xl p-6 flex gap-4 items-start">
            ...
            <div className="flex-1">
                <div className="mb-2">
                    <Link href={`/jobs/${id}`} className="text-xl font-semibold text-gray-800 dark:text-white">{title}</Link>
